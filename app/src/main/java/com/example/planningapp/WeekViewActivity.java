...
import static com.example.planningapp.CalendarUtils.daysInWeeksArray;
...
public class WeekViewActivity extends AppCompatActivity implements CalenderAdapter.OnItemListener
{
    ...
    private void setWeekView()
    {
        ...
        ArrayList<LocalDate> days = daysInWeeksArray(CalendarUtils.selectedDate);
    ...
    private void setEventAdapter()
    {
        ...
        EventAdapterMagic eventAdapter = new EventAdapterMagic(getApplicationContext(), dailyEvents);
